...
async function handler(req, res) {
    ...
    try {
        ...
        const movieCount = await _lib_prismadb__WEBPACK_IMPORTED_MODULE_0__/* ["default"].movie.count */ .Z.movie.count();
        const randomIndex = Math.floor(Math.random() * movieCount);
        const randomMovies = await _lib_prismadb__WEBPACK_IMPORTED_MODULE_0__/* ["default"].movie.findMany */ .Z.movie.findMany({
            take: 1,
            skip: randomIndex
        });
