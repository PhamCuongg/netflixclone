...
async function handler(req, res) {
    ...
    try {
        const { currentUser  } = await (0,_lib_serverAuth__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z)(req);
        const favoriteMovies = await _lib_prismadb__WEBPACK_IMPORTED_MODULE_0__/* ["default"].movie.findMany */ .Z.movie.findMany({
            where: {
                id: {
...
var __webpack_exports__ = (__webpack_exec__(774));
